...
void generate()
{
   ...
   // Biome assets.
   int mapWaterType = cWaterAtlanteanShallow;
   int mapForestType = cForestAtlanteanLush;
   ...
   rmAreaDefSetWaterType(pondDefID, mapWaterType);
   ...
   // Gold.
   int simsGoldsClassID = rmClassCreate("sim gold class");
   int asymmetricGoldClassID = rmClassCreate("assymetric gold class");
   ...
   int goldAvoidCenter = rmCreateLocDistanceConstraint(cCenterLoc, 30.0, "gold vs center"); // Let's avoid strangling the center.
   ...
   rmAreaDefSetForestType(goldForestDefID, mapForestType);
   ...
   int forestOriginAvoidPond = rmCreateClassDistanceConstraint(pondClassID, 15.0, cClassAreaDistance, "starting forest vs pond");
