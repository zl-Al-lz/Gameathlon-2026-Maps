...
void generate()
{
   ...
   int avoidOasisEdge2 = rmCreateClassDistanceConstraint(oasisClassID, 2.0, cClassAreaEdgeDistance);
   int avoidOasisEdge4 = rmCreateClassDistanceConstraint(oasisClassID, 4.0, cClassAreaEdgeDistance);
   int avoidOasisEdge6 = rmCreateClassDistanceConstraint(oasisClassID, 6.0, cClassAreaEdgeDistance);
   int avoidOasisEdge8 = rmCreateClassDistanceConstraint(oasisClassID, 8.0, cClassAreaEdgeDistance);
   int avoidOasisEdge10 = rmCreateClassDistanceConstraint(oasisClassID, 10.0, cClassAreaEdgeDistance);
   ...
   // Settlements.
   int asymmetricSettlementClassID = rmClassCreate();
   ...
   int symmetricOasisClassID = rmClassCreate();
   int asymmetricOasisClassID = rmClassCreate();
   ...
   // Bonus forests.
   int forestClassAvoidance = rmCreateClassDistanceConstraint(forestClassID, avoidForestMeters * 1.35);
   ...
   rmAreaDefSetForestType(bonusForestDefID, cForestEgyptPalmGrass);
   ...
   // Gold.
   int outerGoldClassID = rmClassCreate();
   ...
   // Define map name.
   string MapName = "Giza - Recalibrated";
