...
void generate()
{
   ...
   // Biome assets.
   int mapWaterType = cWaterGreekLake;
   int mapForestType = forestTypeID;
   int mapCliffType = cCliffGreekGrassSnow;
   int mapCliffTypeB = cCliffGreekSnow;
   int mapCliffTypeC = cCliffGreekGrass;
   ...
   rmAreaDefSetCliffType(olympusDefID, mapCliffType);
   ...
   rmAreaSetCliffType(lowerHillID, mapCliffType);
   ...
   rmAreaSetCliffType(upperHillID, mapCliffTypeB);
   ...
   rmAreaDefSetCliffType(bonusCliffDefID, mapCliffType);
   ...
   for(int i = 0; i < cNumberPlayers; i++)
   {
      ...
      rmAreaSetForestType(bonusInnerForestID, mapForestType);
   ...
   rmAreaDefSetCliffType(olympusBonusAreaDefID, mapCliffType);
   ...
   rmAreaDefSetForestType(mainForestDefID, mapForestType);
   ...
   for(int i = 0; i < 2; i++)
   {
      for(int j = 0; j < 2; j++)
      {
         ...
         rmAreaSetCliffType(sideMountainID, mapCliffType);
   ...
   rmAreaDefSetCliffType(noiseCliffDefID, mapCliffType);
